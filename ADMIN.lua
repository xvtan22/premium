...
local Window = OrionLib:MakeWindow({Name = "ADMIN | Tân Hub Premium", HidePremium = false, IntroText = "ADMIN Library", SaveConfig = true, ConfigFolder = "ADMIN | Tân Hub Premium"})
----------Tab-----------------------
