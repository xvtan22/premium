if getgenv().hub then warn("Dino Hub : Already executed!") return end
getgenv().hub = true
...
local Window = Fluent:CreateWindow({
    Title = game:GetService("MarketplaceService"):GetProductInfo(16732694052).Name .." | Dino Hub - Fisch",
    SubTitle = " (https://discord.gg/jW2ewdrz)", -- discord link
    TabWidth = 160,
