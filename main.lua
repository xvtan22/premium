...
local Window = OrionLib:MakeWindow({Name = "Dino Hub | discord.gg/jW2ewdrz", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "Dino Hub"})
...
local locallv = W:AddLabel("Level")
    ...
    W:AddLabel("[+] VN: MTriet voi Hirimi Tuoi Cac Gi Voi Tao Toan Bon Skidder!!!")
    -- W:AddLabel("May tre trau cua hub hirimi voi mtriet tao deo quan tam")
