...
local L_34_ = L_33_:Window("Dino Hub", Enum.KeyCode.LeftControl)
print("|DINO| Anti AFK")
game:GetService("Players").LocalPlayer.Idled:connect(function()
	print("|DINO| AFK detected, prevented +1")
			...
			if _25msShared.AntiStranger then
				for L_222_forvar0, L_223_forvar1 in pairs(game:GetService("Players"):GetChildren()) do
					if L_223_forvar1.Data.Level.Value >= 2601 or L_223_forvar1.Data.Level.Value > 20000 then
						game.Players.LocalPlayer:Kick("Dino Hub found an Admin!")
						print("|DINO| Detected Stranger, Hopping Server...")
						Hop()
					end
				end
			end
	...
	task.spawn(function()
		...
		if setfflag then
			task.spawn(function()
				...
				print("|DINO| Anti Ban Loaded in: " .. os.clock() - L_228_)
			end)
		else
			print("|DINO| Anti Ban not support this Executor!")
		end
	end)
end)
L_35_.Setting:Line()
...
L_35_.Info:Button("My Youtube (Click Copy)", function()
	setclipboard("www.youtube.com/@candy208-t2z")
end)
...
print("|DINO| Done loaded Dino in: " .. os.clock() - L_1_)
Notify("<Color=White>We are still updating more features...<Color=/>", 10)
Notify("<Color=Blue>Dino con is bede<Color=/>", 8)
