...
local Window = Fluent:CreateWindow({
    Title = "Tandeptrai Hub | Blox Fruits",
    SubTitle = "Beta",
    TabWidth = 160,
...
ImageButton.Image = "http://www.roblox.com/asset/?id=78287827518366"
...
Fluent:Notify({
    Title = "Tandeptrai Hub",
    Content = "Hub đã tải xong.",
    Durtion = 3
})
warn("Cảm ơn bạn đã dùng Hub !!")
